...
-x ignore:mesg='Authentication failsed.'` | FILE0 si riferisce al file passato da riga di comando con indice 0 (è possibile inserire più file con indice diverso)|
